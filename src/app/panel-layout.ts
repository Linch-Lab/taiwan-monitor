...
export class PanelLayoutManager implements AppModule {
  ...
  async renderLayout(): Promise<void> {
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <!-- Taiwan Monitor: proBannerSlot disabled -->
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">Taiwan Monitor</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="#" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">Taiwan Monitor</span>
          </a>
          <a href="https://github.com/Linch-Lab/taiwan-monitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">TAIWAN MONITOR</span>
        ...
        <a class="mobile-menu-item" href="#" target="_blank" rel="noopener">
          ...
          <span class="mobile-menu-item-label">Taiwan Monitor</span>
        </a>
        <div class="mobile-menu-divider"></div>
        <div class="mobile-menu-footer-links">
          <a href="${this.ctx.isDesktopApp ? '#' : '#'}" target="_blank" rel="noopener">Pro</a>
          <a href="${this.ctx.isDesktopApp ? '#' : '#'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? '#' : '#'}" target="_blank" rel="noopener">Docs</a>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">TAIWAN MONITOR</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="#" target="_blank" rel="noopener" class="site-footer-credit">Taiwan Monitor</a></span>
          </div>
        </div>
        <nav>
          <a href="${this.ctx.isDesktopApp ? '#' : '#'}" target="_blank" rel="noopener">Pro</a>
          ...
          <a href="${this.ctx.isDesktopApp ? '#' : '#'}" target="_blank" rel="noopener">Docs</a>
          <a href="#" target="_blank" rel="noopener">Status</a>
          <a href="https://github.com/Linch-Lab/taiwan-monitor" target="_blank" rel="noopener">GitHub</a>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Taiwan Monitor</span>
      </footer>
