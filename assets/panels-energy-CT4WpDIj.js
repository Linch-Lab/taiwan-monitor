var Ke=Object.defineProperty;var Qe=(r,i,e)=>i in r?Ke(r,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[i]=e;var $=(r,i,e)=>Qe(r,typeof i!="symbol"?i+"":i,e);import{P as D}from"./Panel-7nZQI8-8.js";import{getTrendColor as Je,getTrendIndicator as et,formatOilValue as tt,getEuGasStorageData as it}from"./index-CYa4CRqd.js";import{t as x,k as st,f as O}from"./panel-storage-C2uCSYbc.js";import{e as n,u as E,j as nt,f as ne,a as Z,b as at}from"./dom-utils-B8MVJOEB.js";import{n as rt,b as ot,p as lt}from"./widget-store-DdTXyzMy.js";import{m as ae}from"./sparkline-EyuwviXB.js";import{g as be,E as He,a as j,c as V,S as X,r as N}from"./embed-url-DQf_jd4F.js";import{p as ke}from"./gdelt-intel-Bt6nynEG.js";import{a as K,A as Q}from"./attribution-footer-CLmq9sQN.js";import{f as xe,a as $e,s as ct}from"./disruption-timeline-rn1TsGcA.js";import{p as dt,a as pt,d as ut}from"./pipeline-evidence-CqE_XO-h.js";import{getCachedPipelineRegistries as ht,setCachedPipelineRegistries as Ee}from"./pipeline-registry-store-BzuQIWej.js";import{d as ft}from"./storage-evidence-DthMONVc.js";import{getCachedStorageFacilityRegistry as gt,setCachedStorageFacilityRegistry as Te}from"./storage-facility-registry-store-DNtKEObx.js";import{d as re,c as mt}from"./shortage-evidence-CwhDyV8K.js";import{getCachedFuelShortageRegistry as yt,setCachedFuelShortageRegistry as Ae}from"./fuel-shortage-registry-store-DQm0wsoJ.js";import{f as We}from"./hormuz-tracker-SHNMnNed.js";import{fetchCommodityQuotes as vt}from"./index-B52qxJn4.js";import{b as bt}from"./_energy-risk-overview-state-0LaVUMqp.js";import{c as xt}from"./layout-batch-B9PC4ceT.js";import{describeFreshness as $t}from"./persistent-cache-cT66YF0P.js";import{e as Pe}from"./extent-Ccx1MofX.js";import{l as oe}from"./linear-B9BZxnEW.js";import{m as he}from"./max-DBeXZoyG.js";import{s as fe}from"./string-B04_ldoR.js";import{a as wt}from"./arc-CGlAFq2g.js";import{i as Ct}from"./continuous-Ds-kXw0U.js";import{a as ge,m as Y}from"./monotone-804fPAVO.js";import{l as De}from"./line-DEDRnOn1.js";import{s as St,n as kt,a as Et}from"./stack-DSObyWpB.js";function Tt(r){return!!(r!=null&&r.wtiPrice||r!=null&&r.brentPrice||r!=null&&r.usProduction||r!=null&&r.usInventory)}class At extends D{constructor(){super({id:"energy-complex",title:x("panels.energyComplex"),defaultRowSpan:2,infoTooltip:x("components.energyComplex.infoTooltip")});$(this,"analytics",null);$(this,"tape",[]);$(this,"crudeWeeks",[]);$(this,"natGasWeeks",[]);$(this,"euGas",null);$(this,"oilStocksAnalysis",null);$(this,"lngVulnerability",null)}updateAnalytics(e){this.analytics=e,this.render()}updateTape(e){this.tape=e.filter(t=>t.price!==null),this.render()}updateCrudeInventories(e){this.crudeWeeks=e,this.render()}updateNatGas(e){this.natGasWeeks=e,this.render()}updateEuGasStorage(e){this.euGas=e.unavailable?null:e,this.render()}setOilStocksAnalysis(e){this.oilStocksAnalysis=e.unavailable?null:e,this.render()}updateLngVulnerability(e){var t;this.lngVulnerability=(t=e==null?void 0:e.top20LngDependent)!=null&&t.length?e:null,this.render()}renderOilStocksSection(){var d,o,u,h;const e=this.oilStocksAnalysis;if(!e||e.ieaMembers.length===0)return"";const t=e.ieaMembers.map(p=>{const f=p.netExporter?'<span class="energy-net-exporter-badge">Net Exporter</span>':p.daysOfCover!=null?n(String(p.daysOfCover))+" d":"—",y=p.belowObligation?'<span class="energy-below-obligation-badge">Below 90d</span>':"";return`
