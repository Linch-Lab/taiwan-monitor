import{aD as Y}from"./main-CmSp9Hyk.js";import{t as o,d as D}from"./panel-storage-C2uCSYbc.js";import{e as a,s as C,t as L}from"./dom-utils-B8MVJOEB.js";import{p as ie}from"./panels-mAavEITu.js";import{q as pe}from"./gdelt-intel-Bt6nynEG.js";import"./clerk-DvUNuV7p.js";import"./embed-url-DQf_jd4F.js";import"./persistent-cache-cT66YF0P.js";import"./widget-store-DdTXyzMy.js";import"./i18n-qlunRAMb.js";import"./debugbear-rum-CTwHbetR.js";import"./resilience-choropleth-utils-RzpthWna.js";import"./user-location-B56vgcIE.js";import"./data-freshness-BbcT_SU1.js";import"./cached-risk-scores-Bilwk5qW.js";import"./panel-gating-D5fzn_21.js";import"./cross-domain-storage-BkfZ6fhr.js";import"./layout-batch-B9PC4ceT.js";import"./string-B04_ldoR.js";import"./continuous-Ds-kXw0U.js";import"./checkout-CdH-Of-b.js";import"./theme-manager-txZCzc-Z.js";import"./font-settings-B6XmwZwl.js";const I=60;let f=null;function Z(p,t){const s=p.indexOf(":");if(s===-1)return{};const h=p.slice(0,s).trim(),b=p.slice(s+1).trim().replace("{key}",t.trim());return{[h]:b}}function Q(p,t){const s=t.indexOf(":");if(s===-1)return null;const h=t.slice(0,s).trim(),b=t.slice(s+1).trim(),i=p[h];if(!i)return null;const x=b.indexOf("{key}"),y=b.slice(0,x).trim();return y&&!i.startsWith(y)?null:i.slice(y?y.length+1:0).trim()||null}function X(p){const t=p.match(/\(([^)]+)\)\s*$/);return(t==null?void 0:t[1])??p}function Oe(p){var V,W;F();const t=p.existingSpec;f=document.createElement("div"),f.className="modal-overlay active";const s=document.createElement("div");s.className="modal mcp-connect-modal";const h=Y.map(e=>`
