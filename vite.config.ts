...
// import { VitePWA } from 'vite-plugin-pwa'; // Taiwan Monitor: PWA disabled for MVP
...
function sebufApiPlugin(): Plugin {
  // Taiwan Monitor: stub — Supabase Edge Functions replace proto-based API routing
  return { name: 'sebuf-api-stub' };
}
...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    plugins: [
      ...
      youtubeLivePlugin(),
      gpsjamDevPlugin(),
      sebufApiPlugin(), // Taiwan Monitor: stubbed — no proto APIs
