...
// TOOL_REGISTRY was sourced from api/mcp/registry/index (deleted in Taiwan Monitor cleanup).
// Stubbed — suggestTools will always return an empty array.
const TOOL_REGISTRY: Array<{ name: string; description: string }> = [];
